...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 10, 2021 at 07:07 AM
...
CREATE TABLE `ban` (
  ...
  `trangthaiban` tinyint(1) NOT NULL DEFAULT 0 COMMENT '0: Trống; 1: Có người'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
(46, 1, '2021-04-08 14:18:19', '2021-04-09 11:29:16', NULL, 'Nguyễn Duy Thái', '0397059907', 'Vĩnh An, Vĩnh Cửu, Đồng Nai', '14:18:19', '11:29:16', 0, '0.00', '45000.00', 'Đã thanh toán', 45000, 0, 1, NULL),
(47, 1, '2021-04-09 11:30:22', '2021-04-09 11:30:34', '08', NULL, NULL, NULL, '11:30:22', '11:30:34', 0, '598200.00', '6580200.00', 'Đã thanh toán', 7000000, 419800, 0, NULL);
...
(2, 'Nguyễn Đỗ', 'Phúc', 1, '1995-03-31', '123456789', '0975079581', 'An Hảo, Biên Hòa, Đồng Nai', 'images/AnhNhanVien/avatar.jpg', 'NV'),
(3, 'Trịnh Duy Tuấn', 'Anh', 1, '1994-09-27', '147542457', '0942990706', 'Trảng Dài, Biên Hòa, Đồng Nai', 'images/AnhNhanVien/avatar.jpg', 'NV');
...
--
ALTER TABLE `chitiethoadon`
  MODIFY `mahd` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=48;
...
--
ALTER TABLE `monan`
  MODIFY `mamon` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=53;
